...
error_type_t AlsaDevice::do_fill_buffer(const uint8_t* data_start, size_t data_size)
{
...
size_t AlsaDevice::do_capture_data(uint8_t* data_start, size_t data_size, error_type_t& error_code)
{
	int ret;
